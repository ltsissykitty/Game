...
class Trooper(object):
    ...
    def update(self, updatetime, time):
        ...
        if time >= updatetime:
            if self.stateflag == 5:
                self.stateflag = 2
                self.sprite = (80, 0, 40, 40)
            elif self.stateflag == 2:
                self.sprite = (120, 0, 40, 40)
                self.stateflag = 3
            elif self.stateflag == 3:
                self.sprite = (160, 0, 40, 40)
                self.stateflag = 4
            elif self.stateflag == 4:
                self.sprite = (200, 0, 40, 40)
                self.stateflag = 5
        self.location = (self.posx,self.posy)
        self.image = ss.image_at(self.sprite)
...
while 1:    
    ...
    if moveflag > 0:
        moveflag = trooper.move(direction, distance)
